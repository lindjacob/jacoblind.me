...
export default function projectCard({ projectObject }) {
    return (
        <a href={`/portfolio/${projectObject.id}`}
            className={`group/projectCard flex flex-col bg-gray-800 rounded-3xl overflow-clip`}
        >
            <div className='h-3/4 box-border overflow-hidden'>
                <img src={projectObject.featuredImage} className='group-hover/projectCard:scale-110 transition-all duration-300' />
            </div>
